...
| `body_composition.created` | `weight`, `body_fat_percentage`, `body_mass_index`, `lean_body_mass`, `bone_mass`, `body_water_mass`, … |
| `fitness_metrics.created` | `vo2_max`, `cardiovascular_age`, `garmin_fitness_age`, `withings_pulse_wave_velocity`, `withings_metabolic_age` |
